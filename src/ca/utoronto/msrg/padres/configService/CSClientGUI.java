...
public class CSClientGUI extends CSClientImpl implements ActionListener {
	...
	public CSClientGUI(String id) throws ClientException {
		super(id);
	}

	public CSClientGUI(CSClientConfig newConfig) throws ClientException {
		super(newConfig);
	}
	...
	public static void main(String[] args) {
		try {
			...
			CommandLine cmdLine = new CommandLine(CSClientConfig.getCommandLineKeys());
			cmdLine.processCommandLine(args);
			String configFile = cmdLine.getOptionValue(CSClientConfig.CLI_OPTION_CONFIG_FILE,
					CONFIG_FILE_PATH);
			...
			// create the client
			final CSClientGUI guiClient = new CSClientGUI(userConfig);
